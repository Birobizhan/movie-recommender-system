...
const THIRD_QUESTION_DICT = {
  ...
  'Боевик (Экшен)': {
    ...
    options: ['🔫 Криминальный', '🪖 Военный', '🦸 Супергеройский', '🚀 Фантастический', '🕵️ Шпионский', 'Другое']
  },
  'Фантастика': {
  ...
  'Триллер': {
    ...
    options: ['🔪 Психологический', '💻 Технотриллер', '🌌 Научно-фантастический', '☠️ Постапокалиптический', 'Другое']
  },
  'Фэнтези': {
    question: 'Какой мир тебя манит?',
    options: ['🌌 Эпическое', '🌑 Темное', '🏙️ Городское', '📜 Мифологическое', 'Другое']
  },
  'Мелодрама': {
    question: 'Какие эмоции важнее?',
    options: ['💘 Романтическая страсть', '👨👩👧👦 Семейная драма', '🕰️ Историческая любовь', '😢 Трагический выбор', 'Другое']
  },
  'Ужасы': {
  ...
  'Детектив': {
    ...
    options: ['🕵️ Классический', '🔫 Криминальный', '🧠 Психологический', '📜 Исторический', 'Другое']
  },
  'Приключения': {
    question: 'Что вдохновляет?',
    options: ['🌍 Экзотические путешествия', '⚔️ Исторические квесты', '🗺️ Поиски сокровищ', '🏔️ Экстремальное выживание', 'Другое']
  },
  'Исторический': {
    question: 'Какая тема тебе ближе?',
    options: ['⚔️ Военные события', '🏛️ Эпические саги', '🎭 Культурные драмы', 'Другое']
  },
  'Криминал': {
    question: 'Какой аспект преступного мира интересен?',
    options: ['🔫 Гангстерский', '👮 Полицейский', '💼 Финансовые махинации', '⚖️ Тюремные драмы', 'Другое']
  },
  'Военный': {
    question: 'Какой аспект войны важен?',
    options: ['🎖️ Боевые действия', '📜 Исторические реконструкции', '🕵️ Партизанские движения', '😢 Личные драмы солдат', 'Другое']
  },
  'Семейный': {
    question: 'Какие темы важны?',
    options: ['🧒 Детские приключения', '🎭 Семейные комедии', '🐾 Истории с животными', '❤️ Межпоколенческие драмы', 'Другое']
  },
  'Биографический': {
