...
def process_file(file_path):
    ...
    try:
        ...
        # Паттерн: запятая (,)
        # (?!\s) - Negative Lookahead: после запятой НЕ должен быть пробельный символ
        # Это заменяет только те запятые, после которых НЕТ пробела.
        # (Условие на символ перед запятой удалено.)
        ...
        # 5. Запись измененного содержимого обратно в файл
